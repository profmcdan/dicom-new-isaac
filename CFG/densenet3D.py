...
class DenseNet(nn.Module):
    ...
    def __init__(self, sample_size, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            #('conv0', nn.Conv3d(3, num_init_features, kernel_size=7, stride=(1, 2, 2), padding=(3, 3, 3), bias=False)),
            ('conv0', nn.Conv3d(3, num_init_features, kernel_size=7, stride=(2, 2, 2), padding=(3, 3, 3), bias=False)),
